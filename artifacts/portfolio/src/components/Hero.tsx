    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-border bg-background/90 text-xs font-semibold uppercase tracking-[0.18em] text-primary mb-10"
