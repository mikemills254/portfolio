...
export const PortfolioContainer = forwardRef(({ sectionId }, ref) => {
    const Projects = [
        ...
        {
            title: "Auth API 2FA",
            description: "An Express.js JWT Authentication API is a modern authentication system that employs JSON Web Tokens (JWT) to secure web applications. It allows users to register, log in, and access protected resources using token-based authentication.",
            image: Rate,
    ...
    return(
        <Wrapper className='Container p-16 flex flex-col items-center justify-center' bgColor="#b3ccff" id={sectionId} ref={ref}>
            <style>
                {`
                @media (max-width: 768px) {
                    .projectContents {
        ...
        <div className='projectContents flex flex-row item-center justify-center w-full'>
...
export const ContactContainer = forwardRef(({ sectionId }, ref) => {
    ...
    return (
        <Wrapper className='divs h-[100%] items-center flex flex-row justify-around' id={sectionId} bgColor='#5676ff' ref={ref}>
            <style>
                {`
